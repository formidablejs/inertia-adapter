...
class InertiaResponse {
	...
	*/
	setRootView(view){
		...
		if (!((view instanceof _$frameworkφ3.View))) { throw new TypeError("view must be a valid View class.") };
	...
	*/
	withViewData(viewData = {}){
		...
		if (!(_$Helpersφ2.isObject(viewData))) { throw new TypeError("viewData must be an Object.") };
