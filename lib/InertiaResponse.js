...
var _$Helpersφ5 = require('@formidablejs/framework/lib/Support/Helpers'/*$path$*/);
...
var _$Helpersφ7 = require('./Support/Helpers'/*$path$*/);
var _$Helpersφ8 = require('@formidablejs/framework/lib/Support/Helpers'/*$path$*/);
var _$Helpersφ9 = require('@formidablejs/framework/lib/Support/Helpers'/*$path$*/);
class InertiaResponse {
	...
	*/
	constructor(component,props = {}){
		this[Ψ__init__]();
		if (!(_$Helpersφ5.isString(component))) { throw new TypeError("component must be a String.") };
		
		if (!(_$Helpersφ2.isEmpty(props)) && !(_$Helpersφ4.isObject(props))) { throw new TypeError("props must be an Object.") };
	...
	*/
	withViewData(viewData = {}){
		...
		if (!(_$Helpersφ4.isObject(viewData))) { throw new TypeError("data must be an Object.") };
	...
	*/
	with(props = {}){
		...
		if (!(_$Helpersφ4.isObject(props))) { throw new TypeError("props must be an Object.") };
	...
	*/
	setStatusCode(statusCode){
		...
		if (!(_$Helpersφ3.isNumber(statusCode))) { throw new TypeError("statusCode must be a number.") };
	...
	*/
	headers(headers = {}){
		...
		if (!(_$Helpersφ4.isObject(headers))) { throw new TypeError("headers must be an Object.") };
	...
	*/
	resolveRootViewProps(request){
		...
		const rootViewProps = {
			...
			flash: _$Helpersφ9.without(((φ3 = request.req.session._flashed) != null) ? (φ3) : {},['_old'])
		};
	...
	*/
	async handle(request,reply,propKeys,patialKeys){
		...
		if (request.isMethod('GET') && request.hasHeader('x-inertia') && request.header('x-inertia-version') !== _$Helpersφ7.version()) {
		...
		return _$Helpersφ8.view(this._rootView,Object.assign(this._viewData,{dataPage: encodedPageString})).toView(request,reply);
	}
};
